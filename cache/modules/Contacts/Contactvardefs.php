 ...
 $GLOBALS["dictionary"]["Contact"]=array (
  ...
  array (
    ...
    array (
      ...
      'len' => 255,
      'size' => '20',
      'id' => 'Contactsid_number_c',
      'custom_module' => 'Contacts',
    ),
    'inactive_reason_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Inactive Reason',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'inactive_reason_c',
      'vname' => 'LBL_INACTIVE_REASON',
      'type' => 'enum',
      'massupdate' => 0,
      'default' => 'uncontactable',
      'no_default' => false,
      'comments' => 'reason of inactive status',
      'help' => '',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => 0,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'contact_inactive_reason_dom',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Contactsinactive_reason_c',
      'custom_module' => 'Contacts',
    ),
    'jjwg_maps_address_c' => 
    array (
    ...
    array (
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'contact_marital_status',
      'studio' => 'visible',
      'dependency' => NULL,
      'id' => 'Contactsmarital_status_c',
      'custom_module' => 'Contacts',
    ),
    'status_c' => 
    array (
