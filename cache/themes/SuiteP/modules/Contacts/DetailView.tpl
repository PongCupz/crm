...
{capture name="label" assign="label"}{sugar_translate label='LBL_CREDIT_BALANCE' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.credit_balance_c.hidden}
{counter name="panelFieldCount" print=false}

<span class="sugar_field" id="{$fields.credit_balance_c.name}">
{sugar_number_format var=$fields.credit_balance_c.value precision=8 }
</span>
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_INACTIVE_REASON' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.inactive_reason_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.inactive_reason_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.inactive_reason_c.name}" value="{ $fields.inactive_reason_c.options }">
{ $fields.inactive_reason_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.inactive_reason_c.name}" value="{ $fields.inactive_reason_c.value }">
{ $fields.inactive_reason_c.options[$fields.inactive_reason_c.value]}
{/if}
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ID_NUMBER' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{/if} 
<span class="sugar_field" id="{$fields.id_number_c.name}">{$fields.id_number_c.value}</span>
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_MARITAL_STATUS' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.marital_status_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.marital_status_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.marital_status_c.name}" value="{ $fields.marital_status_c.options }">
{ $fields.marital_status_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.marital_status_c.name}" value="{ $fields.marital_status_c.value }">
{ $fields.marital_status_c.options[$fields.marital_status_c.value]}
{/if}
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_PRIMARY_ADDRESS_STATE' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.alt_address_state.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.alt_address_state.name}">{$fields.alt_address_state.value}</span>
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ALT_ADDRESS_CITY' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_PRIMARY_ADDRESS_COUNTRY' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ALT_ADDRESS_COUNTRY' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_PRIMARY_ADDRESS_POSTALCODE' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ALT_ADDRESS_POSTALCODE' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</div>
